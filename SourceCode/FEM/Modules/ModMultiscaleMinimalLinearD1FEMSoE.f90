!##################################################################################################
! This module has the system of equations of  FEM - Multiscale MMLA D1 Model
!--------------------------------------------------------------------------------------------------
! Date: 2017
!
! Authors:  Bruno Klahr
...
!                               
!##################################################################################################
module ModMultiscaleMinimalLinearD1FEMSoE
    ...
    type , extends(ClassNonLinearSystemOfEquations) :: ClassMultiscaleMinimalLinearD1FEMSoE
    ...
    subroutine EvaluateR(this,X,R)
        ...
        class(ClassMultiscaleMinimalLinearD1FEMSoE) :: this
